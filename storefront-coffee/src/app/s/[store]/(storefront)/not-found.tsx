...
// layout's chrome (header/megamenu/footer/minicart) and only supplies the BODY: the "4·0·4" hero + the two
// CTAs.
//
...
export default function StoreNotFound() {
  ...
  // params and lives in the static shell, so the store is unknowable here. p3-7: the fragment therefore
  // re-renders the CTAs against the store `/api/store` confirms, so a shopper under `/s/<store>` stops being
  // sent to the Host's store.
  return (
    <>
