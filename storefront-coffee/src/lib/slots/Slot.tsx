...
//
// The component itself lives in `@forgecommerce/storefront-kit/slots/Slot` — it is shared with the checkout
...
export { Slot } from '@forgecommerce/storefront-kit/slots/Slot';
