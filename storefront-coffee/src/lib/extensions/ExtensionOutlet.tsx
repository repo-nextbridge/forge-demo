...
// `@forgecommerce/storefront-kit/extensions` — the checkout deployable builds its own outlet from the same
...
import { createExtensionOutlet } from '@forgecommerce/storefront-kit/extensions';
...
export type {
  ...
  OrderSlotContext,
  SlotQuery,
} from '@forgecommerce/storefront-kit/extensions';
export { slotQuery } from '@forgecommerce/storefront-kit/extensions';
