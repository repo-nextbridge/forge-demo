...
# resolves to v22.22.3, under the `>=24` the product declares — every birth of 2026-09-03 ran there and
...
# writes a secret. `bin/require-node.sh` owns the number and says at length why it is typed rather than
# derived; `bin/node-floor.guard.mjs` proves this line is first.
