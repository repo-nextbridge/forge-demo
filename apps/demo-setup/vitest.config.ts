...
// MONOREPO and this app lives in `forge-demo`, where that path is nothing at all. An app of this box carried
// exactly that import until pk24/D3 and its three suites collected ZERO tests because the config could not
// load.
